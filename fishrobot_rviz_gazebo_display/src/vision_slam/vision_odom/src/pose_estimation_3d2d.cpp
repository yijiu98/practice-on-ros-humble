    ...
    Mat& R, Mat& t )
{
    ...
    // std::unique_ptr<Block::LinearSolverType> linearSolver = std::make_unique<Block::LinearSolverType>();
    typedef g2o::LinearSolverCSparse<Block::PoseMatrixType> LinearSolverType;// 线性方程求解器
